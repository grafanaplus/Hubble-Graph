...
class GraphCtrl extends MetricsPanelCtrl {
  ...
  onInitEditMode() {
    this.addEditorTab('Axes', 'public/app/plugins/panel/hubble-graph/tab_axes.html', 2);
    this.addEditorTab('Legend', 'public/app/plugins/panel/hubble-graph/tab_legend.html', 3);
    this.addEditorTab('Display', 'public/app/plugins/panel/hubble-graph/tab_display.html', 4);
  ...
  link(scope, elem, attrs, ctrl) {
    scope.metricsEditorElm = elem[0].getElementsByTagName('panel-editor-tab-hubble-graph1');
    scope.$watch('metricsEditorElm.length', () => {
      if (scope.metricsEditorElm.length !== 0) {
        scope.metricsEditorElm[0].style['pointer-events'] = "none";
      }
    });
  }
  exportCsvColumns() {
